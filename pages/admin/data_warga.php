            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <a class="btn btn-success" href="./tambah_data.php">+ DATA WARGA</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <tbody style="text-align: center;">
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a type="tambah" class="btn btn-primary" href="./edit_warga.php?id=<?= $d['id'] ?>" role="button">Edit</a>

                            <a class="btn btn-danger" href="./hapus_akun.php?id=<?= $d['id'] ?>" role="button">Hapus</a>
                          </td>
