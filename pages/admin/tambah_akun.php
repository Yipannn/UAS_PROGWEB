...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
                ...
                <form action="" method="post">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="email" name="email" placeholder="Masukan E-mail">
                    </div>
                    <div class="form-group">
                      <label>Status</label>
    ...
    if (isset($_POST['submit'])) {
      ...
      $query = mysqli_query($koneksi, "INSERT INTO users (id,username,password,nama,email,status,role) VALUES ('','$username','$password','$nama','$email','$status','$role') ");
    }
    ?>
    <!-- /.content-wrapper -->
